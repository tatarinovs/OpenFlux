# OpenFlux — Маскированный сетевой туннель, Windows GUI и Android-клиент
...
Данный репозиторий — расширенный форк p1neappleXpress/OpenFlux
...
┌─────────────────────────────────────────────────────────┐
│                    Клиентская часть                     │
│  [Windows GUI / Android / Браузер] ──> SOCKS5 (:1080)   │
